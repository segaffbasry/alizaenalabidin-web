...
export function FooterRed() {
  return (
    <footer className="bg-[#FF2727] px-5 sm:px-10 lg:px-20 pt-10 sm:pt-14 lg:pt-16 pb-8 sm:pb-10">

      {/* Copyright */}
      <p style={{ fontFamily: "'Work Sans', sans-serif", fontWeight: 400, fontSize: 14, color: "rgba(255,255,255,0.55)", marginBottom: 40 }}>
        Copyright © {new Date().getFullYear()} – All Right Reserved
      </p>

      {/* Main grid — 1 col mobile, 2 col md, 3 col lg */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-0 items-center mb-10 lg:mb-16">

        {/* Col 1 — newsletter */}
        <div>
          <h3 style={{
            fontFamily: "'Work Sans', sans-serif",
            fontWeight: 600, fontSize: "clamp(28px, 5vw, 48px)", lineHeight: 1.2,
            color: "#fff", marginBottom: 24,
          }}>
            Get notified<br />for Ali&apos;s update
          </h3>
          <NewsletterForm variant="red" />
        </div>

        {/* Col 2 — spacer (desktop only) */}
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
          <blockquote style={{
            ...
            fontWeight: 700, fontSize: "clamp(13px, 1.6vw, 20px)", lineHeight: 1.6,
          ...
          <p style={{
            ...
            fontWeight: 400, fontSize: "clamp(28px, 4vw, 48px)", lineHeight: 1.2,
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.2)", paddingTop: 24, display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div className="flex items-center justify-center md:justify-end gap-4 md:gap-5" style={{ color: "#fff" }}>
          <a href="https://www.instagram.com/alizaenalabidin/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><InstagramIcon /></a>
          <a href="https://www.linkedin.com/in/aliabidin" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><LinkedInIcon /></a>
          <a href="https://www.youtube.com/@AliZaenalAbidin" target="_blank" rel="noopener noreferrer" aria-label="YouTube"><YouTubeIcon /></a>
          <a href="https://www.tiktok.com/@aliabidin.official" target="_blank" rel="noopener noreferrer" aria-label="TikTok"><TikTokIcon /></a>
          <a href="https://x.com/insightali?lang=en" target="_blank" rel="noopener noreferrer" aria-label="X"><XIcon /></a>
        </div>
      </div>
